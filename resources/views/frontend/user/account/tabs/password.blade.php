<x-forms.patch :action="route('frontend.auth.password.change')" >
    <div class="form-group row">
        <label for="current_password" class="col-md-6 col-form-label text-md-left">@lang('Current Password')</label>
    ...
    <div class="form-group row">
        <label for="password" class="col-md-6 col-form-label text-md-left">@lang('New Password')</label>
    ...
    <div class="form-group row">
        <label for="password_confirmation" class="col-md-12 col-form-label text-md-left">@lang('New Password Confirmation')</label>
